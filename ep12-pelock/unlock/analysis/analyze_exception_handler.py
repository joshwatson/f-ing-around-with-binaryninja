...
def analyze_exception_handler_set_var(self, expr: MediumLevelILInstruction):
    ...
    elif self.seh_state == SEHState.LookingForPop:
...
def analyze_exception_handler_store(self, expr: MediumLevelILInstruction):
    ...
    if self.seh_state == SEHState.PushSeh:
    ...
    elif self.seh_state == SEHState.InException:
        return self.analyze_unwind(expr)

    elif self.seh_state == SEHState.Unwinding and self.fs in expr.dest.prefix_operands:
